...
INSERT INTO `facturacion`.`usuarios` (`usuario`, `password`) VALUES ('david', '1');
INSERT INTO `facturacion`.`usuarios` (`usuario`, `password`) VALUES ('hugo', '1');
INSERT INTO `facturacion`.`usuarios` (`usuario`, `password`) VALUES ('eduardo', '1');
INSERT INTO `facturacion`.`usuarios` (`usuario`, `password`) VALUES ('miguela', '1');

INSERT INTO `facturacion`.`formadepago` (`descripcion`,`valor`) VALUES ('Pago Completo.', 0);
INSERT INTO `facturacion`.`formadepago` (`descripcion`,`valor`) VALUES ('Pago a Tres Meses', 3);
